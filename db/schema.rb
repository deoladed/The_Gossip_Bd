...
ActiveRecord::Schema.define(version: 2019_01_31_134153) do
  ...
  create_table "potins_tags", id: false, force: :cascade do |t|
    t.integer "potin_id"
    t.integer "tag_id"
    t.index ["potin_id"], name: "index_potins_tags_on_potin_id"
    t.index ["tag_id"], name: "index_potins_tags_on_tag_id"
  end
